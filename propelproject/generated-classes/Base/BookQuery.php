 ...
 * @method     ChildBookQuery orderByHighlighted($order = Criteria::ASC) Order by the highlighted column
 *
 ...
 * @method     ChildBookQuery groupByHighlighted() Group by the highlighted column
 *
 ...
 *
 * @method     ChildBookQuery leftJoinBookPublisher($relationAlias = null) Adds a LEFT JOIN clause to the query using the BookPublisher relation
 * @method     ChildBookQuery rightJoinBookPublisher($relationAlias = null) Adds a RIGHT JOIN clause to the query using the BookPublisher relation
 * @method     ChildBookQuery innerJoinBookPublisher($relationAlias = null) Adds a INNER JOIN clause to the query using the BookPublisher relation
 *
 * @method     ChildBookQuery joinWithBookPublisher($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the BookPublisher relation
 *
 * @method     ChildBookQuery leftJoinWithBookPublisher() Adds a LEFT JOIN clause and with to the query using the BookPublisher relation
 * @method     ChildBookQuery rightJoinWithBookPublisher() Adds a RIGHT JOIN clause and with to the query using the BookPublisher relation
 * @method     ChildBookQuery innerJoinWithBookPublisher() Adds a INNER JOIN clause and with to the query using the BookPublisher relation
 *
 * @method     \AuthorQuery|\BookPublisherQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildBook findOneByHighlighted(boolean $highlighted) Return the first ChildBook filtered by the highlighted column *
 ...
 * @method     ChildBook requireOneByHighlighted(boolean $highlighted) Return the first ChildBook filtered by the highlighted column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildBook[]|ObjectCollection findByHighlighted(boolean $highlighted) Return ChildBook objects filtered by the highlighted column
...
abstract class BookQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, title, description, isbn, author_id, highlighted FROM books WHERE id = :p0';
        try {
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(BookTableMap::COL_DESCRIPTION, $description, $comparison);
    }
    ...
    /**
     * Filter the query on the highlighted column
     *
     * Example usage:
     * <code>
     * $query->filterByHighlighted(true); // WHERE highlighted = true
     * $query->filterByHighlighted('yes'); // WHERE highlighted = true
     * </code>
     *
    ...
    public function filterByHighlighted($highlighted = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(BookTableMap::COL_HIGHLIGHTED, $highlighted, $comparison);
    }
    ...
    /**
     * Filter the query by a related \BookPublisher object
     *
     * @param \BookPublisher|ObjectCollection $bookPublisher the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildBookQuery The current query, for fluid interface
     */
    public function filterByBookPublisher($bookPublisher, $comparison = null)
    {
        if ($bookPublisher instanceof \BookPublisher) {
            return $this
                ->addUsingAlias(BookTableMap::COL_ID, $bookPublisher->getBookId(), $comparison);
        } elseif ($bookPublisher instanceof ObjectCollection) {
            return $this
                ->useBookPublisherQuery()
                ->filterByPrimaryKeys($bookPublisher->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByBookPublisher() only accepts arguments of type \BookPublisher or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the BookPublisher relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildBookQuery The current query, for fluid interface
     */
    public function joinBookPublisher($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('BookPublisher');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'BookPublisher');
        }
    ...
    /**
     * Use the BookPublisher relation BookPublisher object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \BookPublisherQuery A secondary query class using the current class as primary query
     */
    public function useBookPublisherQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinBookPublisher($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'BookPublisher', '\BookPublisherQuery');
    }

    /**
     * Filter the query by a related Publisher object
     * using the book_publishers table as cross reference
     *
     * @param Publisher $publisher the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildBookQuery The current query, for fluid interface
     */
    public function filterByPublisher($publisher, $comparison = Criteria::EQUAL)
    {
        return $this
            ->useBookPublisherQuery()
            ->filterByPublisher($publisher, $comparison)
            ->endUse();
    }
