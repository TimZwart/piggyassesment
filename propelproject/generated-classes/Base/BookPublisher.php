...
/**
 * Base class that represents a row from the 'book_publishers' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class BookPublisher implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\BookPublisherTableMap';
    ...
    /**
     * Initializes internal state of Base\BookPublisher object.
     */
    ...
    /**
     * Compares this with another <code>BookPublisher</code> instance.  If
     * <code>obj</code> is an instance of <code>BookPublisher</code>, delegates to
     * <code>equals(BookPublisher)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|BookPublisher The current object, for fluid interface
     */
     ...
     * @return $this|\BookPublisher The current object (for fluent API support)
     */
    public function setBookId($v)
    {
        ...
        if ($this->book_id !== $v) {
            $this->book_id = $v;
            $this->modifiedColumns[BookPublisherTableMap::COL_BOOK_ID] = true;
        }
    ...
    public function setPublisherId($v)
    {
        ...
        if ($this->publisher_id !== $v) {
            $this->publisher_id = $v;
            $this->modifiedColumns[BookPublisherTableMap::COL_PUBLISHER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BookPublisherTableMap::translateFieldName('BookId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->book_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BookPublisherTableMap::translateFieldName('PublisherId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = BookPublisherTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\BookPublisher'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBookPublisherQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see BookPublisher::setDeleted()
     * @see BookPublisher::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBookPublisherQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BookPublisherTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BookPublisherTableMap::COL_BOOK_ID)) {
            $modifiedColumns[':p' . $index++]  = 'book_id';
        }
        if ($this->isColumnModified(BookPublisherTableMap::COL_PUBLISHER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'publisher_id';
        }

        $sql = sprintf(
            'INSERT INTO book_publishers (%s) VALUES (%s)',
    ...
    {
        $pos = BookPublisherTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['BookPublisher'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BookPublisher'][$this->hashCode()] = true;
        $keys = BookPublisherTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setPublisherId($arr[$keys[1]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BookPublisherTableMap::COL_BOOK_ID)) {
            $criteria->add(BookPublisherTableMap::COL_BOOK_ID, $this->book_id);
        }
        if ($this->isColumnModified(BookPublisherTableMap::COL_PUBLISHER_ID)) {
            $criteria->add(BookPublisherTableMap::COL_PUBLISHER_ID, $this->publisher_id);
        }
    ...
    {
        $criteria = ChildBookPublisherQuery::create();
        $criteria->add(BookPublisherTableMap::COL_BOOK_ID, $this->book_id);
        $criteria->add(BookPublisherTableMap::COL_PUBLISHER_ID, $this->publisher_id);
    ...
    public function hashCode()
    {
        ...
        //relation book_publishers_fk_19cfd3 to table books
        ...
        //relation book_publishers_fk_e69726 to table publishers
    ...
    {
        return (null === $this->getBookId()) && (null === $this->getPublisherId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \BookPublisher (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \BookPublisher Clone of current object.
     * @throws PropelException
     */
    ...
    public function getBook(ConnectionInterface $con = null)
    {
        if ($this->aBook === null && ($this->book_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBook->addBookPublishers($this);
             */
        }
    ...
    public function getPublisher(ConnectionInterface $con = null)
    {
        if ($this->aPublisher === null && ($this->publisher_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPublisher->addBookPublishers($this);
             */
        }
    ...
    {
        if (null !== $this->aBook) {
            $this->aBook->removeBookPublisher($this);
        }
        if (null !== $this->aPublisher) {
            $this->aPublisher->removeBookPublisher($this);
        }
        $this->book_id = null;
    ...
    {
        return (string) $this->exportTo(BookPublisherTableMap::DEFAULT_STRING_FORMAT);
    }
