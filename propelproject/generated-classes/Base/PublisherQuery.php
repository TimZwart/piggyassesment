 ...
 *
 * @method     ChildPublisherQuery leftJoinBookPublisher($relationAlias = null) Adds a LEFT JOIN clause to the query using the BookPublisher relation
 * @method     ChildPublisherQuery rightJoinBookPublisher($relationAlias = null) Adds a RIGHT JOIN clause to the query using the BookPublisher relation
 * @method     ChildPublisherQuery innerJoinBookPublisher($relationAlias = null) Adds a INNER JOIN clause to the query using the BookPublisher relation
 *
 * @method     ChildPublisherQuery joinWithBookPublisher($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the BookPublisher relation
 *
 * @method     ChildPublisherQuery leftJoinWithBookPublisher() Adds a LEFT JOIN clause and with to the query using the BookPublisher relation
 * @method     ChildPublisherQuery rightJoinWithBookPublisher() Adds a RIGHT JOIN clause and with to the query using the BookPublisher relation
 * @method     ChildPublisherQuery innerJoinWithBookPublisher() Adds a INNER JOIN clause and with to the query using the BookPublisher relation
 *
 * @method     \BookPublisherQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PublisherQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, name FROM publishers WHERE id = :p0';
        try {
    ...
    public function filterByBookPublisher($bookPublisher, $comparison = null)
    {
        if ($bookPublisher instanceof \BookPublisher) {
            return $this
                ->addUsingAlias(PublisherTableMap::COL_ID, $bookPublisher->getPublisherId(), $comparison);
