...
class BookTableMap extends TableMap
{
     ...
     */
    const COL_DESCRIPTION = 'books.description';
     ...
     */
    const COL_AUTHOR_ID = 'books.author_id';

    /**
     * the column name for the highlighted field
     */
    const COL_HIGHLIGHTED = 'books.highlighted';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Description', 'Isbn', 'AuthorId', 'Highlighted', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'description', 'isbn', 'authorId', 'highlighted', ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID, BookTableMap::COL_TITLE, BookTableMap::COL_DESCRIPTION, BookTableMap::COL_ISBN, BookTableMap::COL_AUTHOR_ID, BookTableMap::COL_HIGHLIGHTED, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'description', 'isbn', 'author_id', 'highlighted', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Description' => 2, 'Isbn' => 3, 'AuthorId' => 4, 'Highlighted' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'description' => 2, 'isbn' => 3, 'authorId' => 4, 'highlighted' => 5, ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID => 0, BookTableMap::COL_TITLE => 1, BookTableMap::COL_DESCRIPTION => 2, BookTableMap::COL_ISBN => 3, BookTableMap::COL_AUTHOR_ID => 4, BookTableMap::COL_HIGHLIGHTED => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'description' => 2, 'isbn' => 3, 'author_id' => 4, 'highlighted' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('highlighted', 'Highlighted', 'BOOLEAN', false, 1, false);
    } // initialize()
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('BookPublisher', '\\BookPublisher', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':book_id',
    1 => ':id',
  ),
), 'CASCADE', 'CASCADE', 'BookPublishers', false);
        $this->addRelation('Publisher', '\\Publisher', RelationMap::MANY_TO_MANY, array(), 'CASCADE', 'CASCADE', 'Publishers');
    } // buildRelations()
    /**
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BookTableMap::COL_HIGHLIGHTED);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.highlighted');
        }
    }
