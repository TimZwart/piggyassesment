...
class PublisherTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'publishers.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'publishers.name';
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Book', '\\Book', RelationMap::MANY_TO_MANY, array(), 'CASCADE', 'CASCADE', 'Books');
    } // buildRelations()
    /**
     * Method to invalidate the instance pool of all tables related to publishers     * by a foreign key with ON DELETE CASCADE
     */
